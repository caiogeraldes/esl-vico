...
\begin{table}[!htb]
	\begin{adjustwidth}{0cm}{0cm}
		\caption[Particípio presente ativo, flexão indeterminada]{Particípio
		presente ativo, flexão indeterminada\\{\small(Damos aqui as formas
		dos casos diretos e aqueles do genitivo. O resto da flexão segue os temas em
		-\ocsex{jo}- (em -\ocsex{ja}- pra os femininos.))}}\label{tab:partatvindet}
		\begin{center}
