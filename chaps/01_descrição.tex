...
chamado de búlgaro antigo (alem.~\emph{Altbulgarisch}).
...
(alem.~\emph{Altkirchenslavisch}, ing.~\emph{Old Church Slavonic}).
...
imperador bizantino Constatino IV em 680.
...
\begin{table}[!htb]
  ...
  \begin{center}
    \begin{tabular}[c]{llll||llll}
      ...
      {\ocs{}Ⰴ}   & {\rus{}Д} & d  & [d]   & {\ocs{}Ⱍ} & {\rus{}Ч}     & č    & [tʃ,]\\
      {\ocs{}Ⰵ}   & {\rus{}Є} & e  & [ʲe]  & {\ocs{}Ⱎ} & {\rus{}Ш}     & š    & [ʃ,]\\
      {\ocs{}Ⰶ}   & {\rus{}Ж} & ž  & [ʒ]   & {\ocs{}Ⰰ} & {\rus{}А}     & št   & [ʃt,]\\
      {\ocs{}Ⰷ}   & {\rus{}Ѕ} & dz & [dz,] & {\ocs{}Ⱏ} & {\rus{}Ъ}     & ŭ, ъ & [ə]\\
      {\ocs{}Ⰸ}   & {\rus{}З} & z  & [z]   & {\ocs{}ⰟⰊ } & {\rus{}Ꙑ ЪИ}     & y    &\\
      {\ocs{}Ⰹ Ⰺ} & {\rus{}И} & i  & [i]   & {\ocs{}Ⱐ} & {\rus{}Ь}     & ĭ    & [ʲe]\\
      {\ocs{}Ⰻ}   & {\rus{}Ꙇ} & i  & [i]   & {\ocs{}Ⱑ} & {\rus{}Ѣ}     & ě    & [ʲa]\\
      {\ocs{}Ⰼ}   & {\rus{}Ћ} & g' & [g,]  & {\ocs{}Ⱓ} & {\rus{}Ю}     & ju   & [ju]\\
      {\ocs{}Ⰽ}   & {\rus{}К} & k  & [k]   & {\ocs{}}  & {\rus{}Ꙗ}     & ja   & [ja]\\
      {\ocs{}Ⰾ}   & {\rus{}Л} & l  & [l]   & {\ocs{}}  & {\rus{}Ѥ}     & je   & [je]\\
                  & {\rus{}Л҄} & l' & [l']  & {\ocs{}Ⱔ} & {\rus{}Ѧ}     & ę    & [ɛ̃]\\
      {\ocs{}Ⰿ}   & {\rus{}М} & m  & [m]   & {\ocs{}Ⱗ} & {\rus{}Ѩ}     & ję   & [jɛ̃]\\
      {\ocs{}Ⱀ}   & {\rus{}Н} & n  & [n]   & {\ocs{}Ⱘ} & {\rus{}Ѫ}     & ǫ    & [ɔ̃]\\
                  & {\rus{}Н҄} & n' & [n,]  & {\ocs{}Ⱙ} & {\rus{}Ѭ}     & jǫ   & [jɔ̃]\\
...
{\rus{}В}/\emph{v} que vale 2, e não {\rus{}Б}/\emph{b}, que não possui valor
numérico, {\rus{}Г}/\emph{g} = 3, etc.).
...
\begin{compactitem}[--]
    \item \emph{Folhas de Kiev} (ou \emph{Missal de Kiev}) [\emph{Kiev}],
    ...
    \item Codex Marianus [Mar.], quatro evangelhos (171 + 2 fol., faltam os
      ...
      leituras divergentes de \emph{Zogr.}, \emph{Ass.}, \emph{Sav.} e do
      \emph{Evangelho de Ostromir}).
    \item \emph{Codex Assemanius} [\emph{Ass.}], evangeliários (158 fol., glagol.,
    ...
    \item \emph{Savvina kniga} [\emph{Sav.}], evangeliário (130 fol., ciríl., XI°,
    ...
    \item Palimpsesto do Vaticano, fragmento de evangeliário (93 foi., ciríl.,
    ...
    \item \emph{Codex Suprasliensis} [\emph{Supr.}], menólogo de \emph{mars} e
      homilías (118 + 16 + 151 fol., ciríl., XI, Bulgária), um dos manuscritos
      mais recentes, posterior a \emph{Sav.} Ed.\ J. Zaimov, M. Capaldo,
      \emph{Suprasǎlski ili Retkov sbornik}, Sofia, 1982--1983 (fac-símile,
      comentário, texto grego).
    \item \emph{Clozianus} [\emph{Cloz.}], fragmento de homiliário (12 + 2 foi.,
...
\begin{compactitem}[--]
  ...
  XI--começo do XII). Ed.\ \emph{cf.} \emph{Zogr.}
  ...
  \item \emph{Apostol de Enina}, Atos dos apóstolos (39 fol., ciríl., fim do
    XI--começo do XI, Bulgária). Ed.\ K.\ Mirčev, Ch.\ Kodov, \emph{Eninski
      ...
      glossário).
  \item \emph{Folheto de Kiev}: \emph{recto} do fol. 1 do \emph{Missal de Kiev}
    com um fragmento da Epístola aos Romanos e uma prece mariana (glagol., fim
    do XI) (\emph{cf.} acima \emph{Kiev}).
...
Uma vez que o cirílico é derivado da uncialgrega e que em grego apenas a
...
notaremos \emph{esm\soft} `eu sou', \emph{tvoě} `tua' (\textsc{nom.fem.sg.} do
possessivo) nos exemplos de \emph{Mar.} ou de \emph{Zogr.} e não a transcrição
normalizada \emph{jesm\soft} \emph{tvoja} utilizada na descrição morfológica.
Os exemplos de \emph{Supr.} e de \emph{Sav.} (que estão em cirílico) serão
...
\emph{Marianus} (Mt = Mateus, M = Marcos, L = Lucas, J = João) e os salmos de
