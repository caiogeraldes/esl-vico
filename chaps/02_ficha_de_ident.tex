...
\begin{table}[!htb]
  ...
  \begin{center}
    \begin{tabular}[c]{lllll}
      \toprule
      \emph{Vogais breves} & *ĭ > \emph{ь} & *ĕ > \emph{e} & *ă, ŏ > *ă >
      \emph{o} & *ŭ > \emph{ъ}\\
               & & \hspace{1em} > \emph{o}\slash{}\emph{-u̯} & & \\
      \midrule
      \emph{Vogais longas} & *ī > \emph{i} & *ē > \ocsex{E}
...
* -ŭn} > \emph{*-ŭ} > -\emph{ъ} (\gloss{ac.sg.} temático \cirilocsex{градъ,gradъ} <
*\emph{g\textsuperscript{h}ord\textsuperscript{h}om}). Por outro lado,
\emph{ō} não se fecha diante de nasal: *-\emph{ōm\#} >
*-\emph{ōn} > -\emph{ǫ} (\gloss{1ªsg} temática \cirilocsex{нєсѫ,nesǫ}
...
\emph{*-ū} > -\emph{y} (\gloss{ac.pl.} temático \cirilocsex{градꙑ,grady} <
...
como consequência da homofonia das formas de \gloss{ac.sg.} nos dois tipos
(*-\emph{on\#} > *-\emph{ŭn}); para os primeiros o
\gloss{nom.acc.sg} neutro do tipo em -\emph{s-} \cirilocsex{слово,slovo} ``fala''
...
*-\emph{os}-\emph{Ø}). Nas duas hipóteses, o -\emph{o} do \gloss{nom.acc.sg}
...
e o imperativo \gloss{2ªsg} \cirilocsex{нєсти,nesi} ``leva'' < -\emph{ois}
