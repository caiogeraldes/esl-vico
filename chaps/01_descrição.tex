...
O \glsxtrlong{eslavoantigo} é uma língua morta, conhecida pelos textos do século X e XI\@.
Os textos eslavos antigos são quase todos textos religiosos traduzidos do grego
e não há literatura original em \glsxtrlong{eslavoantigo}.
Os únicos textos originais são inscrições, pouco numerosas, mas nos quais
formulação cristã é de origem grega.

O \glsxtrlong{eslavoantigo} foi a língua falada pelos eslavos dos Bálcãs orientais, no
...
representa uma continuação do \glsxtrlong{eslavoantigo}, adaptada superficialmente às
particularidades de cada uma das línguas eslávicas.
Neste sentido, as variantes modernizadas do \glsxtrlong{eslavoantigo} persistiram até que a
língua se tornasse morta, mas em um contexto extremamente restrito de uso
litúrgico.

Apontamos tradicionalmente o fim do \glsxtrlong{eslavoantigo} e a passagem ao búlgaro
...
\begin{figure}[!htb]
	...
	\end{center}
	\caption{Eslavos durante os séculos VIII-IX\@. Fonte:
		\href{https://pt.wikipedia.org/wiki/Ficheiro:East_Slavic_tribes_peoples_8th_9th_century.jpg}{Wikimedia}}\label{fig:eslavos_sec8_9}
\end{figure}
...
como um equivalente ao ``\glsxtrlong{eslavoantigo}'' em sua totalidade, seja para designar o
dialeto búlgaro do \glsxtrlong{eslavoantigo} em oposição ao dialeto macedônio, o que será
útil aqui.
...
do sudeste, e faz de Ócrida sua capital.
...
tem por capital Tărnovo, que durará até a conquista turca em 1393.
Esse segundo reino da Bulgária corresponde ao período búlgaro moderno e a língua
desta época ja não é mais o \glsxtrlong{eslavoantigo}.

\begin{figure}[!htb]
	\begin{center}
		\includegraphics[width=0.75\textwidth]{assets/Structure_of_the_First_Bulgarian_Empire_during_the_IX-X_century.png}
	\end{center}
	\caption{Primeiro reino búlgaro. Fonte:
		\href{https://commons.wikimedia.org/wiki/File:Structure_of_the_First_Bulgarian_Empire_during_the_IX-X_century.png}{Wikimedia}}\label{fig:reino_bulgaria}
\end{figure}

\section{Grafia}

O \glsxtrlong{eslavoantigo} é grafado com dois alfabetos diferentes, que se sucedem e que
...
\cirigraf{i2} e \cirigraf{i} para /i/ (grego \grafema{Ι} e
\grafema{i}, pronunciado [i] por causa do iotacismo), \cirigraf{o} e
\cirigraf{o2} para /o/, enquanto para \emph{u} há a notação
\cirigraf{u}, calque do dígrafo grego \grafema{ΟΥ};
...
fricativas \emph{š}, \emph{ž}, \emph{č}, a africada \emph{c} e as vogais nasais
\emph{ę} e \emph{ǫ}) se faz por meio de grafemas do alfabeto glagolítico.
...
\begin{table}[!htb]
	...
	\begin{center}
		\begin{tabular}[c]{llll||llll}
			...
			\glagolex{Ⰱ}   & \cirilex{Б} & b         & [b]   & \glagolex{Ⱇ}   & \cirilex{Ф}    & f    & [f]   \\
			\glagolex{Ⰲ}   & \cirilex{В} & v         & [v]   & \glagolex{Ⱈ}   & \cirilex{Х}    & x    & [x]   \\
			\glagolex{Ⰳ}   & \cirilex{Г} & g         & [g]   & \glagolex{Ⱌ}   & \cirilex{Ц}    & c    & [ts]  \\
			\glagolex{Ⰴ}   & \cirilex{Д} & d         & [d]   & \glagolex{Ⱍ}   & \cirilex{Ч}    & č    & [tʃ,] \\
			\glagolex{Ⰵ}   & \cirilex{Є} & e         & [ʲe]  & \glagolex{Ⱎ}   & \cirilex{Ш}    & š    & [ʃ,]  \\
			\glagolex{Ⰶ}   & \cirilex{Ж} & ž         & [ʒ]   & \glagolex{Ⱋ}   & \cirilex{щ}    & št   & [ʃt,] \\
			\glagolex{Ⰷ}   & \cirilex{Ѕ} & dz        & [dz,] & \glagolex{Ⱏ}   & \cirilex{Ъ}    & ŭ, ъ & [ə]   \\
			\glagolex{Ⰸ}   & \cirilex{З} & z         & [z]   & \glagolex{ⰟⰊ } & \cirilex{Ꙑ ЪИ} & y    &       \\
			\glagolex{Ⰹ Ⰺ} & \cirilex{И} & i         & [i]   & \glagolex{Ⱐ}   & \cirilex{Ь}    & ĭ    & [ʲe]  \\
			\glagolex{Ⰻ}   & \cirilex{Ꙇ} & i         & [i]   & \glagolex{Ⱑ}   & \cirilex{Ѣ}    & ě    & [ʲa]  \\
			\glagolex{Ⰼ}   & \cirilex{Ћ} & g'        & [g,]  & \glagolex{Ⱓ}   & \cirilex{Ю}    & ju   & [ju]  \\
			\glagolex{Ⰽ}   & \cirilex{К} & k         & [k]   & {}             & \cirilex{Ꙗ}    & ja   & [ja]  \\
			\glagolex{Ⰾ}   & \cirilex{Л} & l         & [l]   & {}             & \cirilex{Ѥ}    & je   & [je]  \\
			               & \cirilex{Л҄} & l'        & [l']  & \glagolex{Ⱔ}   & \cirilex{Ѧ}    & ę    & [ɛ̃]   \\
			\glagolex{Ⰿ}   & \cirilex{М} & m         & [m]   & \glagolex{Ⱗ}   & \cirilex{Ѩ}    & ję   & [jɛ̃]  \\
			\glagolex{Ⱀ}   & \cirilex{Н} & n         & [n]   & \glagolex{Ⱘ}   & \cirilex{Ѫ}    & ǫ    & [ɔ̃]   \\
			               & \cirilex{Н҄} & n'        & [n,]  & \glagolex{Ⱙ}   & \cirilex{Ѭ}    & jǫ   & [jɔ̃]  \\
			\glagolex{Ⱁ}   & \cirilex{О} & o         & [ɔ]   & \glagolex{Ⰰ}   & \cirilex{Ѯ}    & ks   & [ks]  \\
			\glagolex{Ⱂ}   & \cirilex{П} & p         & [p]   & \glagolex{Ⰰ}   & \cirilex{Ѱ}    & ps   & [ps]  \\
			\glagolex{Ⱃ}   & \cirilex{Р} & r         & [r]   & \glagolex{Ⱚ}   & \cirilex{Ѳ}    & t    & [t]   \\
			               & \cirilex{Р҄} & r'        & [r,]  & \glagolex{Ⱛ}   & \cirilex{Ѵ}    & u    & [u]   \\
			\glagolex{Ⱄ}   & \cirilex{С} & s         & [s]   & \glagolex{Ⱉ}   & \cirilex{Ѡ}    & o    & [o]   \\
			\glagolex{Ⱅ}   & \cirilex{Т} & t         & [t]   &                &                &      &       \\
			\bottomrule
		\end{tabular}
	\end{center}
\end{table}
...
\cirilex{В}\slash{}\emph{v} que vale 2, e não \cirilex{Б}\slash{}\emph{b}, que não possui valor
numérico, \cirilex{Г}\slash{}\emph{g} = 3, etc.).
...
pelo \emph{titulus}, um sinal \grafema{ \cirilex{ ҃  }}, colocado acima da palavra abreviada.
...
No entanto, os tradutores e copistas da escola de Ócrida mantiveram o uso do
glagolítico.
...
texto do período macedônio, da escola de Ócrida.
...
\textcite{BirnbaumSchaeken1999}), fragmento de um saltério em \glsxtrlong{eslavoantigo},
está em cirílico: data-se eles do primeiro quarto do século XI e eles assim se
juntam aos documentos mais antigos em \glsxtrlong{eslavoantigo} conservados (edição
...
o incluiremos à lista de textos em \glsxtrlong{eslavoantigo} canônicos.

\section{Documentos}

O corpus \glsxtrlong{eslavoantigo} \emph{stricto sensu} é constituído por um número limitado
...
\begin{compactitem}[--]
	...
	\emph{Mariinskoe četveroevangelie, s primečanijami i s priloženijami}, S.
	...
	XI, Macedônia). Ed. J. Vajs, J. Kurz, \emph{Evangeliář Assemanuv, Kodex
	...
	final do séc.\ X--começo do XI, Bulgária). Ed. T. Kraštanov \emph{et al.},
	\emph{Vatikansko evangelie. Starobălgarski kirilski aprakos ot X.\ v.\ v
		palimpsesten Kodeks Vat.\ Gr.\ 2502}, Sofia, 1996 (apenas texto).
	\item \emph{Folhas da Ócrida}, fragmento de evangeliário e de lecionário (2
	...
	segunda metade do século XI). Ed.\ M. Altbauer, V. Mareš, ``Fragmentum
	...
	Tessalônica 1988 (para a primeira parte do manuscrito), F. Mareš,
	...
	\emph{Suprasǎlski ili Retkov sbornik}, Sofia, 1982--1983 (fac-símile,
	...
	\emph{Folhas da Ócrida} acima).
	\item \emph{Folha de Grigorovič} (1 fol.\ bastante danificado, glagol., XI,
	Macedônia). Ed.\ Lysaght 1982 (transcrição cirílica e fac-símile)
	(\emph{cf.} \emph{Folhas da Ócrida} acima).
\end{compactitem}
...
\begin{compactitem}[--]
	...
	acima, \emph{Folhas da Ócrida}).
	\item \emph{Apostol de Enina}, Atos dos apóstolos (39 fol., ciríl., fim do
	XI--começo do XI, Bulgária). Ed.\ K.\ Mirčev, Ch.\ Kodov, \emph{Eninski
		apostol. Starobălgarski pametnik ot XI v.}, Sofia, 1965 (fac-símile,
	glossário).
	...
	(\emph{cf.} acima, \emph{Folhas da Ócrida}).
...
\emph{Starobălgarski nadpisi / Altbulgarische Inschriften I}, Salzburg, 1994.
...
Outros documentos eslavos, contemporâneos ao \glsxtrlong{eslavoantigo}, chegaram até nós,
...
Esta obra se propõe a uma descrição do \glsxtrlong{eslavoantigo} em sentido estrito, de modo
...
cânone, recomendamos a \emph{Syntaxe} de R.\ Večerka.\nocite{Vecerka2003}
...
um grafema para /je/ distinto de /e/, nem um grafema para /ja/ distinto de /ě/),
