	...
	\begin{adjustwidth}{0cm}{0cm}
		...
		\begin{center}
			\begin{tabular}[c]{llllll}
				...
				\rowcolor{gray!10} & \emph{inst.}     & \cirilex{agnẽtemI}                        & \ocsex{agnẽt-emI}                         & \cirilex{slovesemI} & \ocsex{sloves-emI} \\
				\rowcolor{gray!10} &                  &                                           &                                           & \cirilex{slovesImI} & \ocsex{sloves-ImI} \\
				                   & \emph{loc.}      & \cirilex{agnẽte}                          & \ocsex{agnẽt-e}                           & \cirilex{slovese}   & \ocsex{sloves-e}   \\
				                   &                  & \cirilex{agnẽti}                          & \ocsex{agnẽt-i}                           & \cirilex{slovesi}   & \ocsex{sloves-i}   \\
				\midrule
