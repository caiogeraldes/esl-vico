...
\subsubsection{Determinantes}\label{sec:determinação}
\lipsum[6]
...
\subsection{Objeto}
\lipsum[13]
\subsection{Complemento nominal}\label{sec:complnom}
\lipsum[14]
\subsection{Adjuntos}
\lipsum[15]
...
\lipsum[17]
\subsection{Reflexividade de reciprocidade}\label{5.3.2}
\lipsum[18]
\subsection{Anáfora e catáfora}
\lipsum[19]
\subsection{Determinação}
\lipsum[20]
\subsection{Quantificação}\label{5.3.5}
\lipsum[21]
\subsection{Negação}\label{sec:negacao}
\lipsum[22]
