...
\begin{compactitem}[--]
    ...
    \item \glsxtrlong{Marianus} [\glsxtrshort{Marianus}], quatro evangelhos (171 + 2 fol., faltam os
      ...
      leituras divergentes de \glsxtrshort{Zogr}, \emph{Ass.}, \glsxtrshort{Sav} e do
...
notaremos \emph{\ocstrans{esmI}} `eu sou', \emph{\ocstrans{tvoE}} `tua' (\textsc{nom.fem.sg.} do
possessivo) nos exemplos de \glsxtrshort{Marianus} ou de \glsxtrshort{Zogr} e não a transcrição
normalizada \emph{\ocstrans{jesmI}} \emph{tvoja} utilizada na descrição morfológica.
