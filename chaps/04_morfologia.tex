...
nom.sg. em -\emph{ę} para os presentes em -\emph{je}-. A alternância
...
interrogativas (\emph{imate li čьto}? ``tendes algo?'' L 24,41) ou
...
(\emph{iscěli i} ``ele o cura'' L 22, 51). O alinhamento com os outros
pronomes, contudo, suscitou a substituição de /\cirilocsex{jь} por
\cirilocsex{jego}, forma do genitivo, já nos \emph{Evangelhos}
(\emph{prědajęi ego} ``aquele que o trai'' M 14,55), portanto, com um
...
singular (\emph{vъprosi ję} ``ele os interrogou'' Mt. 22, 41
